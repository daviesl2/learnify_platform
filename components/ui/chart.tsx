      ...
      <div
        ...
        className={cn(
          "flex aspect-video justify-center text-xs " +
            ...
            "[&_.recharts-cartesian-grid_line[stroke='#ccc']]:stroke-gray-300/50 " +
            "[&_.recharts-curve.recharts-tooltip-cursor]:stroke-gray-300 " +
            "[&_.recharts-dot[stroke='#fff']]:stroke-transparent " +
            "[&_.recharts-layer]:outline-none " +
            "[&_.recharts-polar-grid_[stroke='#ccc']]:stroke-gray-300 " +
  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "grid min-w-[8rem] items-start gap-1.5 rounded-lg border border-gray-300/50 bg-white px-2.5 py-1.5 text-xs shadow-xl",
          className
        )}
      >
